...
void depthToClould()
{
   myCloud.reset(new pcl::PointCloud<pcl::PointXYZ>);
       ...
       for(int col=start_x; col < end_x; col++)       
        {
          ...
          if(semantic_img.at<uchar>(row, col) > 0)
...
int main(int argc, char **argv)
{
  ...
  nh_.getParam("num_scenes", num_scenes);
