...
#include "hiqp_time_point.h"

namespace force_controllers {

  HiQPTimePoint::HiQPTimePoint() : sec_(0), nsec_(0) {}
  HiQPTimePoint::HiQPTimePoint(unsigned int sec, unsigned int nsec) : sec_(sec), nsec_(nsec) {}
  HiQPTimePoint::HiQPTimePoint(const HiQPTimePoint& other) : sec_(other.getSec()), nsec_(other.getNSec()) {}
