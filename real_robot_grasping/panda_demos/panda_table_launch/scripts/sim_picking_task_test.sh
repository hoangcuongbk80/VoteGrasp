...
- name: 'ee_frame'
  ...
  parameters: [0.0, 0.0, 0.1, 3.14, 0.0, 1.57]
...
- name: 'full_pose'
  ...
  def_params: ['TDefFullPose', '0.0', '-1.17', '0.003', '-2.89', '-0.0', '1.82', '0.84']
  dyn_params: ['TDynPD', '16.0', '10.0']
- name: 'ee_frame_project'
  priority: 3
  visible: 1
  active: 1
  monitored: 1
  def_params: ['TDefGeomProj', 'frame', 'frame', 'ee_frame = goal_frame']
...
- name: 'ee_frame_align'
  ...
  active: 1
  monitored: 1
  def_params: ['TDefGeomAlign', 'frame', 'frame', 'ee_frame = goal_frame']
  dyn_params: ['TDynPD', '200', '500']
